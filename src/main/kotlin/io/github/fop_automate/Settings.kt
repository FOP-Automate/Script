...
class CommandLineArgumentSettings(val args: Array<String>) : SettingsSource {
    ...
    init {
        ...
        options.addOption("rp", "repo-prefix", true, "Repository Prefix")
        options.addOption("dp", "repo-dir-prefix", true, "Repository Directory Prefix")
        ...
        repoPrefix = cmd.getOptionValue("rp")
        repoDirPrefix = cmd.getOptionValue("dp")
